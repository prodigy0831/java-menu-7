...
import menu.controller.subcontroller.IntializingController;
...
public class MainController {
    ...
    private void initializeControllers() {
        controllers.put(ApplicationStatus.INITIALIZE_MENUS, new IntializingController(inputView, outputView));
